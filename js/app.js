...
///////////////// locations ///////////////////
var seattle = SalmonCookies('Seattle', 23, 65, 6.3);
 console.log(seattle);
 var tokyo = SalmonCookies('Tokyo', 3, 24, 1.2);
 console.log(tokyo);
 var dubai = SalmonCookies('Dubai', 11, 38, 3.7);
 console.log(dubai);
 var paris = SalmonCookies('Paris', 20, 38, 2.3);
 console.log(paris);
 var lima = SalmonCookies('Lima', 2, 16, 4.6);
 console.log(lima);
