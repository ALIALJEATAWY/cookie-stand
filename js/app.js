...
///////// form /////////
   var addform = document.getElementById('addplace');
   addform.addEventListener('submit', submittion);
   
   function submittion(event) {
   event.preventDefault();

   var newplace = event.target.locationfield.value;
   console.log(newplace);
   var newminimum = Number(event.target.numberfield1.value);
   console.log(newminimum);
   var newmaximum = Number(event.target.numberfield2.value);
   console.log(newmaximum);
   var newavareg = Number(event.target.numberfield3.value);
